    ...
    <div className="space-y-4">
      <div className="space-y-3">
        <Input
          ...
          className={`text-base bg-white dark:bg-slate-100 text-slate-900 dark:text-slate-900 shadow-sm placeholder:text-slate-400 hover:bg-slate-50 hover:border-slate-400 dark:hover:bg-slate-200 dark:hover:border-slate-400 focus:ring-2 focus:ring-slate-500 focus:border-slate-500 ${
            props.errorMessage
